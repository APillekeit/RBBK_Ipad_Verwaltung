...
# VOLLSTÄNDIGES PRODUKTIONS-DEPLOYMENT für Frontend
# Verwendung: Wenn package.json geändert wurde
# sudo bash deploy-production-full.sh

echo "════════════════════════════════════════════════════════"
echo "  🚀 Frontend Produktions-Deployment (VOLLSTÄNDIG)"
echo "  ⚠️  Mit --no-cache (für package.json Änderungen)"
echo "════════════════════════════════════════════════════════"
echo ""
...
# Schritt 4: Frontend neu bauen (OHNE CACHE)
echo "🔨 [4/6] Baue Frontend neu (OHNE Cache - yarn install neu)..."
echo "⏳ Dies dauert 3-5 Minuten (yarn install läuft komplett)..."
...
echo "   docker logs ipad_frontend_build"
echo ""
echo "⏱️  Gesamtdauer: ~3-5 Minuten (vollständiger Rebuild)"
echo "════════════════════════════════════════════════════════"
